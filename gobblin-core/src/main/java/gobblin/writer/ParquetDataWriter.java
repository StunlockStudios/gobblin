 ...
 */
public class ParquetDataWriter implements DataWriter<GenericRecord>, FinalState {

	private static final Logger LOG = LoggerFactory.getLogger(ParquetDataWriter.class);
	...
	private synchronized String addRecordCountToFileName() throws IOException {
		...
		String filePathWithRecordCount = new IngestionRecordCountProvider().constructFilePath(filePath,
				recordsWritten());
