 ...
 * @author ziliu
 */
public class AvroToOrcDataWriterBuilder<S> extends FsDataWriterBuilder<S, AvroGenericRecordWritable> {
  ...
  @Override
  public DataWriter<AvroGenericRecordWritable> build() throws IOException {
    ...
    return new AvroToOrcDataWriter(this, properties);
  }
