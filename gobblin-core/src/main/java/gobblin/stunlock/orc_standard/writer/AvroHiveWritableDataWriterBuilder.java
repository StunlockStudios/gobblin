 ...
 * @author ziliu
 */
public class AvroHiveWritableDataWriterBuilder<S> extends FsDataWriterBuilder<S, AvroHiveWritableRecord> {
  ...
  @Override
  public DataWriter<AvroHiveWritableRecord> build() throws IOException {
    ...
    return new AvroHiveWritableDataWriter(this, properties);
  }
